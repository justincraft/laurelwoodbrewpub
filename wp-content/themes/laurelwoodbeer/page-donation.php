        ...
        <div class="row-fluid">
            <div id="content" class="span12">
                <div class="post" id="post-<?php the_ID(); ?>">
                    <h2><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">Enter your donation request info below:</a></h2>
                    ...
                    <div class="entry">                                                       
                        ...
                        <form id="donationform" action="/wp-content/themes/laurelwoodbeer/donateprocess.php" method="post">
                       ...
                       <p class="options"><label class="optionheader">Event Type <span>(Check all that apply)</span></label>
                        ...
                        <p><label>&nbsp;</label>
                        <input type="submit" alt="Submit" id="formsubmit" value="Submit" style="font-size: 20px; padding: 2px 4px;" /></p>
