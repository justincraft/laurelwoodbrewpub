...
Foodeez Lite WordPress Theme, Copyright 2014 SketchThemes.
Foodeez Lite WordPress theme is distributed under the terms of the GNU GPL.


/*========= Credits =========*/

--------------------- Script Credits "Foodeez Lite WordPress Theme" ---------------------
...
--------------------- Image credits "Foodeez Lite WordPress Theme" ---------------------
...
= 1.0.2 =
* change sketch_get_option to foodeez_lite_get_option.
* Remove demo-meta-boxes.php,demo-theme-options.php file.
* Remove all meta-boxes options.
* Change prefix of all functions to foodeez_lite.


= 1.0.1 =
* Fixed Depreciated Functions issue.
* Fixed Some of Theme Check issue.
* Fixed Some of Security and Privacy issue.
* Fixed Some of Licensing, Theme Name, Credit Links, Up-Sell Themes issue.
