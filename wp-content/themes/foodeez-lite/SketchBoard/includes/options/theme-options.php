...
global $foodeez_lite_shortname;
  ...
  $custom_settings = array(
    ...
    'settings'        => array(
		...
		array(
			'label'       => __( 'Change Logo (full path to logo image size: width * height (156px * 40px) )', 'foodeez-lite'),
		...
		array(
			'label'       => __( 'First Featured Box Image Path (size: width * height (150px * 150px) )', 'foodeez-lite'),
		...
		array(
			'label'       => __( 'Second Featured Box Image Path (size: width * height (150px * 150px) )', 'foodeez-lite'),
		...
		array(
			'label'       => __( 'Third Featured Box Image Path (size: width * height (150px * 150px) )', 'foodeez-lite'),
		...
		array(
			'label'       => __( 'Fourth Featured Box Image Path (size: width * height (150px * 150px) )', 'foodeez-lite'),
