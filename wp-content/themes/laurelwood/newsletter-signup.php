...
<div id="columnwrap">
            ...
            <form name="ccoptin" action="http://visitor.r20.constantcontact.com/d.jsp" method="post">
                ...
                <input type="text" name="ea" maxlength="120" value="email address !!" onfocus="if (this.value == 'email address') { this.value='';}" onblur="if (this.value == '') { this.value='email address';}" id="inputemail"  /><br />
