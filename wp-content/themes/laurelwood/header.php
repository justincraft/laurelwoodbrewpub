...
<?php if ($_SERVER["REQUEST_URI"] == "/category/blog/")
		{
			echo "<title>" . "News and Events | Laurelwood Brewery and Public House" . "</title>";
		}

	  else if ((get_post_meta($post->ID, 'page_title', true))!=="")
		{
			echo "<title>" . (get_post_meta($post->ID, 'page_title', true)) . "</title>";
		}
	  else
		{
			echo "<title>" . "Welcome to Laurelwood Brewery and Public House" . "</title>";
		}
		?>

<?php if(get_post_meta($post->ID, 'meta_desc', true)) { ?>
<meta name="description" content="<?php echo(get_post_meta($post->ID, 'meta_desc', true)); ?>">
<?php } ?>
...
<meta name="copyright" content="2001-2013 Laurelwood Public House and Brewery" />
...
<meta property="og:image" content="https://www.laurelwoodbrewpub.com/wp-content/themes/laurelwood/images/logo-trans.png" />
...
<![endif]-->
<link rel="stylesheet" type="text/css" href="/wp-content/themes/laurelwood/fancybox/fancybox/jquery.fancybox-1.3.4.css" media="screen" />

<script type="text/javascript" src="/wp-content/themes/laurelwood/fancybox/jquery-1.4.3.min.js"></script>
<script type="text/javascript" src="/wp-content/themes/laurelwood/includes/js/jquery-ui-1.7.2.custom.min.js"></script>
<script type="text/javascript" src="/wp-content/themes/laurelwood/fancybox/fancybox/jquery.fancybox-1.3.4.js"></script>
