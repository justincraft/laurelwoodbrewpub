...
LWBP Lite WordPress Theme, Copyright 2014 SketchThemes.
LWBP Lite WordPress theme is distributed under the terms of the GNU GPL.


/*========= Credits =========*/

--------------------- Script Credits "LWBP Lite WordPress Theme" ---------------------
...
--------------------- Image credits "LWBP Lite WordPress Theme" ---------------------
...
= 1.0.2 =
* change sketch_get_option to laurelwoodbrewpub_get_option.
* Remove demo-meta-boxes.php,demo-theme-options.php file.
* Remove all meta-boxes options.
* Change prefix of all functions to laurelwoodbrewpub.
