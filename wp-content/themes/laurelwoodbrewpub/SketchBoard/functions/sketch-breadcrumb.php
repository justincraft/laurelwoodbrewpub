...
class laurelwoodbrewpub_breadcrumb_class {
    ...
    function custom_breadcrumb() {
        ...
        echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . home_url() . '/">' . __('Home', 'laurelwoodbrewpub') . '</a>';
    ...
    function simple_breadcrumb_case($der_post) {
        ...
        if (is_author()) {
            ...
            return __('Author', 'laurelwoodbrewpub') . ' : ' . $curauth->display_name;
        ...
        if (is_tag()) {
            ...
            return __('Tag', 'laurelwoodbrewpub') . ' : ' . single_tag_title('', false);
        ...
        if (is_search()) {
            ...
            return __('Search', 'laurelwoodbrewpub');

        }

		if (is_404()) {            return __('Error 404', 'laurelwoodbrewpub');        }
...
$laurelwoodbrewpub_breadcumb = new laurelwoodbrewpub_breadcrumb_class();
