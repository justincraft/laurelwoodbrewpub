      ...
      foreach( (array) $this->options as $option ) {
        ...
        foreach( (array) $this->get_pages( $option ) as $page ) {
          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
			...
			$sktlink = "http://www.sketchthemes.com/themes/lwbp-multi-cuisine-restaurant-wordpress-theme/";
			 $sktratelink = "http://wordpress.org/support/view/theme-reviews/laurelwoodbrewpub";
            
            echo '	<div class="donate-info">
					<strong>'. __( "To Activate All Features, Please Upgrade to Pro version!", "laurelwoodbrewpub" ) .'</strong><br/>
					<a title="'. __( "Upgrade to Pro", "laurelwoodbrewpub" ) .'" href="'. esc_url($sktlink) .'" target="_blank" class="upgrade">'. __( "Upgrade to Pro", "laurelwoodbrewpub" ) .'</a>	<a title="'. __( 'Setup Instructions', 'laurelwoodbrewpub' ) .'" href="'. get_template_directory_uri().'/Installation_Instructions.txt' .'" target="_blank" class="donate">'. __( 'Setup Instructions', 'laurelwoodbrewpub' ) .'</a>
					<a title="'. __( 'Rate LWBP Lite', 'laurelwoodbrewpub' ) .'" href="'. esc_url($sktratelink) .'" target="_blank" class="review">'. __( 'Rate LWBP Lite', 'laurelwoodbrewpub' ) .'</a>
					<div id="social-share">
					<div class="fb-like">
              ...
              echo '<div id="option-tree-header-wrap">';
                ...
                echo '<ul id="option-tree-header">';
                  ...
                  echo '<li id="option-tree-version"><span>Version ' . laurelwoodbrewpub_THEME_VERSION . '</span></li>';
