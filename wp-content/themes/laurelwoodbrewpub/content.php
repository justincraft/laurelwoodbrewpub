...
<div <?php post_class('post'); ?> id="post-<?php the_ID(); ?>">
        ...
        <div class="featured-image-shadow-box">
			<?php
					$thumbnail = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID),'laurelwoodbrewpub_standard_img');
			?>
        ...
        <div class="skepost clearfix">
			<?php the_excerpt(); ?> 
			<div class="continue"><a href="<?php the_permalink(); ?>"><?php _e('Read More','laurelwoodbrewpub');?></a></div>		  
        </div>
        <!-- skepost -->
</div>
<!-- post -->