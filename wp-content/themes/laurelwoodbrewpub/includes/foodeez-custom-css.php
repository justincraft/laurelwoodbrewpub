<?php global $laurelwoodbrewpub_shortname, $laurelwoodbrewpub_themename, $post; ?>
<?php
 
	if(laurelwoodbrewpub_get_option($laurelwoodbrewpub_shortname.'_colorpicker')){ $bg_color = laurelwoodbrewpub_get_option($laurelwoodbrewpub_shortname.'_colorpicker'); } 
	if(laurelwoodbrewpub_get_option($laurelwoodbrewpub_shortname.'_fullparallax_image')){ $fullparallax_image = laurelwoodbrewpub_get_option($laurelwoodbrewpub_shortname.'_fullparallax_image'); }   	
	if(laurelwoodbrewpub_get_option($laurelwoodbrewpub_shortname.'_innerheader_stype')){ $innerheader_image = laurelwoodbrewpub_get_option($laurelwoodbrewpub_shortname.'_innerheader_stype'); }   	
